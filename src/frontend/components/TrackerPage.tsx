              ...
              <HStack justify="space-between">
                <HStack spacing={4}>
                  ...
                  <VStack align="start" spacing={0}>
                    ...
                    <Text fontSize="3xl" fontWeight="bold">Level {stats.avgLevel}</Text>
                ...
                <SimpleGrid columns={4} spacing={8}>
                  <Stat textAlign="center">
                    <StatLabel color="gray.400">Active Trackers</StatLabel>
                    <StatNumber fontSize="2xl">{stats.totalTrackers}</StatNumber>
                  </Stat>
                  <Stat textAlign="center">
                    <StatLabel color="gray.400">Completions</StatLabel>
                    <StatNumber fontSize="2xl" color="green.400">
                      {stats.totalCompletions}
                    </StatNumber>
                  </Stat>
                  <Stat textAlign="center">
                    <StatLabel color="gray.400">Active Streaks</StatLabel>
                    <StatNumber fontSize="2xl" color="orange.400">
                      {stats.activeStreaks} 🔥
                    </StatNumber>
                  </Stat>
                  <Stat textAlign="center">
                    <StatLabel color="gray.400">Best Streak</StatLabel>
                    <StatNumber fontSize="2xl" color="yellow.400">
                      {stats.longestStreak} 🏆
                    </StatNumber>
                  </Stat>
                </SimpleGrid>
