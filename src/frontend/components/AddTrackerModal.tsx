...
import type { Tracker, CreateTrackerPayload, TrackerFrequency } from '@/lib/types';
  ...
  useEffect(() => {
    if (isOpen) {
      if (editTracker) {
        ...
        setGenerateTasks(editTracker.generateTasks);
          ...
          <VStack spacing={5}>
            ...
            <FormControl>
              <HStack justify="space-between">
                <Box>
                  <FormLabel mb={0}>Auto-generate Tasks</FormLabel>
                  <FormHelperText mt={1}>
                    Automatically create tasks based on this tracker
                  </FormHelperText>
                </Box>
                <Switch
                  isChecked={generateTasks}
            ...
            {/* Scheduling Options - shown when generateTasks is enabled */}
            {generateTasks && (
              <Box
                w="100%"
                p={4}
